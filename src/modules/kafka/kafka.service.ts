...
export class KafkaService { 
    ...
    private kafkaInfo = new Kafka({clientId: "cumsumer1_"+uuidv4(),brokers: [this.config.get('KAFKA_HOST')]});
    ...
    //토픽 
    private readonly TEST_TOPIC = 'test-topic';
    ...
    constructor(
        ...
        this.consumer.subscribe({ topics: [this.TEST_TOPIC] });//구독
